...
#define RTERR_VALCMPERR  -74     /* value comparison error               */
#define RTERR_BUFCMPERR  -75     /* buffer comparison error              */
 ...
 * @return             A pointer to the allocated linked list structure.
 */
EXTERNRT OSRTSList* rtxSListCreate();
...
/**
 * This function converts a size-typed variable into a character
 * string.  It is similar to the C \c itoa function.
 *
 * @param value        Integer to convert.
 * @param dest         Pointer to destination buffer to receive string.
...
(OSSIZE value, char* dest, size_t bufsiz, char padchar);
